...
//const { buildCAClient, registerAndEnrollUser, enrollAdmin, getUserAttributes } = require('../../test-application/javascript/CAUtil.js');
...
//const org1UserId6 = 'javascriptAppUser6';
...
async function main() {
	try {
		...
		// await registerAndEnrollUser(caClient, wallet, mspOrg1, org1UserId2, 'org1.department1');
